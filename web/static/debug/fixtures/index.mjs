...
const fixtures = {
  ...
  StorageUseStats: () => [
    { Type: 'Seal', Capacity: 500000000000000, Available: 120000000000000, CapStr: '455 TiB', UseStr: '345 TiB' },
    { Type: 'Store', Capacity: 1024000000000000, Available: 256000000000000, CapStr: '931 TiB', UseStr: '698 TiB' },
  ],

  StorageStoreTypeStats: () => [
    { type: 'sealed', capacity: 512000000000000, available: 128000000000000, avail_str: '116 TiB' },
    { type: 'cache', capacity: 128000000000000, available: 32000000000000, avail_str: '29 TiB' },
    { type: 'unsealed', capacity: 64000000000000, available: 16000000000000, avail_str: '14 TiB' },
  ],

  StoragePathList: () => [
    {
      StorageID: 'aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee',
      LocalPath: '/data/hot',
      PathType: 'Store',
      CanSeal: false,
      CanStore: true,
      Capacity: 500000000000000,
      Available: 120000000000000,
      FSAvailable: 120000000000000,
      CapacityStr: '455 TiB',
      AvailableStr: '109 TiB',
      UsedPercent: 76,
      ReservedPercent: 2,
      HealthOK: true,
      HealthStatus: 'OK (3s ago)',
      HostList: ['10.0.1.10:3456'],
      AllowTypesList: [],
      DenyTypesList: [],
    },
    {
      ...
      CanSeal: true,
      CanStore: true,
      Capacity: 200000000000000,
      Available: 80000000000000,
      FSAvailable: 80000000000000,
      CapacityStr: '182 TiB',
      AvailableStr: '73 TiB',
      UsedPercent: 60,
      ReservedPercent: 5,
      HealthOK: true,
      HealthStatus: 'OK (1s ago)',
      HostList: ['10.0.1.11:3456', '10.0.1.12:3456'],
      AllowTypesList: ['unsealed'],
      DenyTypesList: [],
    },
  ],
  ...
  PDPGuideStatus: () => ({
    wallet: {
      ...
      filAddress: 'f410fuo4dghaeiqzokiqnxruzdr6e3cjktnxprrc56bi',
      balance: '8 FIL',
      funded: true,
      actorExists: true,
      detail: 'Wallet configured and funded.',
    },
    storage: {
      ok: true,
      pathCount: 2,
      ...
      availableHuman: '120 GiB',
      capacityHuman: '500 GiB',
      meetsMinimum: true,
      meetsRecommended: true,
      docsURL: 'https://docs.curiostorage.org/curio-pdp#storage',
      detail: '120 GiB available across 2 path(s).',
    },
    dns: {
      ok: false,
      ...
      httpEnabled: true,
      reachable: false,
      reachableDetail: 'dial tcp: connection refused',
      suggestTunnel: true,
      tunnelInstalled: false,
      tunnelRunning: false,
      tunnelDetail: 'cloudflared is not installed.',
      detail: 'Domain is configured but not reachable from this node. A Cloudflare Tunnel can expose the PDP API without opening inbound ports.',
    },
    registry: {
      ok: false,
      registered: false,
      detail: 'Not registered with the Filecoin Onchain Cloud service provider registry.',
    },
  }),
