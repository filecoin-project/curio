...
if __name__ == "__main__":
    ...
    for e in [ "LOTUS_PATH", "LOTUS_MARKETS_PATH", "LOTUS_MINER_PATH", "LOTUS_STORAGE_PATH", "LOTUS_WORKER_PATH", "WORKER_PATH", "LOTUS_PANIC_REPORT_PATH", "WALLET_PATH", "LOTUS_PANIC_REPORT_PATH", "CURIO_REPO_PATH", "CURIO_DB_HOST", "CURIO_DB_NAME"]:
