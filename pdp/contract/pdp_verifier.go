...
//
// Solidity: function calculateProofFee(uint256 setId, uint256 gasUsed) view returns(uint256)
func (_PDPVerifier *PDPVerifierCaller) CalculateProofFee(opts *bind.CallOpts, setId *big.Int, gasUsed *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _PDPVerifier.contract.Call(opts, &out, "calculateProofFee", setId, gasUsed)
...
//
// Solidity: function calculateProofFee(uint256 setId, uint256 gasUsed) view returns(uint256)
func (_PDPVerifier *PDPVerifierSession) CalculateProofFee(setId *big.Int, gasUsed *big.Int) (*big.Int, error) {
	return _PDPVerifier.Contract.CalculateProofFee(&_PDPVerifier.CallOpts, setId, gasUsed)
}

// CalculateProofFee is a free data retrieval call binding the contract method 0x4903704a.
//
// Solidity: function calculateProofFee(uint256 setId, uint256 gasUsed) view returns(uint256)
func (_PDPVerifier *PDPVerifierCallerSession) CalculateProofFee(setId *big.Int, gasUsed *big.Int) (*big.Int, error) {
	return _PDPVerifier.Contract.CalculateProofFee(&_PDPVerifier.CallOpts, setId, gasUsed)
}
