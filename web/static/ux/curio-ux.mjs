       ...
       <div class="d-flex flex-column flex-shrink-0 p-3 text-white" style="width: 240px; min-height:100vh; margin-right: 1rem; background-color: #2a2a2e;">
          ...
          <hr>
            <ul class="nav nav-pills flex-column">
              ...
              <li>
                <a href="/pages/remote-seal/" class="nav-link text-white ${active=='/pages/remote-seal/'? 'active':''}">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi me-2 bi-cloud-upload" viewBox="0 0 16 16">
