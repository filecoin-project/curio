...
func run() error {
	tfb, err := os.ReadFile("./deps/config/types.go")
	if err != nil {
		return err
	}
	...
	fmt.Print(`// Code generated by github.com/filecoin-project/curio/deps/config/cfgdocgen. DO NOT EDIT.
