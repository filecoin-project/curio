...
class MK20PDPDealList extends LitElement {
    static properties = {
        deals: { type: Array },
        limit: { type: Number },
        offset: { type: Number },
    ...
    async loadData() {
        try {
            ...
            this.deals = await RPCCall('MK20PDPStorageDeals', params);
            this.requestUpdate();
        } catch (error) {
            console.error('Failed to load pdp deals:', error);
        }
    }
    ...
    render() {
      ...
      <div>
        ...
        <h2>PDP Deal List
              ...
              List of all PDP deals including the deals currently in pipeline. Use the pagination controls to navigate through the list.
            </span>
                </button>
            </h2>
        </h2>
...
customElements.define('mk20-pdp-deal-list', MK20PDPDealList);