...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "mk20.PDPV1": {
            ...
            "properties": {
                "add_root": {
                    "description": "AddRoot indicated that this deal is meant to add root to a given ProofSet. ProofSetID must be defined.",
                    "type": "boolean"
                },
                "create_proof_set": {
                    "description": "CreateProofSet indicated that this deal is meant to create a new ProofSet for the client by storage provider.",
                    "type": "boolean"
                },
                "delete_proof_set": {
                    "description": "DeleteProofSet indicated that this deal is meant to delete an existing ProofSet created by SP for the client.\nProofSetID must be defined.",
                    "type": "boolean"
                },
                "delete_root": {
                    "description": "DeleteRoot indicates whether the root of the data should be deleted. ProofSetID must be defined.",
                    "type": "boolean"
                },
                "extra_data": {
                ...
                "proof_set_id": {
                    "description": "ProofSetID is PDP verified contract proofset ID. It must be defined for all deals except when CreateProofSet is true.",
                    "type": "integer"
                },
                "record_keeper": {
                    "description": "RecordKeeper specifies the record keeper contract address for the new PDP proofset.",
                    "type": "string"
                },
                "root_ids": {
                    "description": "RootIDs is a list of root ids in a proof set.",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    }
