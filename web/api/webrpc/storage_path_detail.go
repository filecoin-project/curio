...
func (a *Handler) StoragePathDetail(ctx context.Context, storageID string) (*StoragePathDetailResult, error) {
	// Get basic path info
...
func (a *Handler) StoragePathSectors(ctx context.Context, storageID string, limit, offset int) (*StoragePathSectorsResult, error) {
	// Get total count
	var total int
...
func (a *Handler) HostToMachineID(ctx context.Context, hosts []string) (map[string]int64, error) {
	if len(hosts) == 0 {
