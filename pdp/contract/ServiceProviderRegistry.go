...
// FilterProductAdded is a free log retrieval operation binding the contract event 0xc03038a9ecf24bce3ca992cd5fc58cfc5eef92df68bdcce2a38ad62026932e6e.
//
// Solidity: event ProductAdded(uint256 indexed providerId, uint8 indexed productType, address serviceProvider, bytes productData, string[] capabilityKeys, string[] capabilityValues)
...
// WatchProductAdded is a free log subscription operation binding the contract event 0xc03038a9ecf24bce3ca992cd5fc58cfc5eef92df68bdcce2a38ad62026932e6e.
//
// Solidity: event ProductAdded(uint256 indexed providerId, uint8 indexed productType, address serviceProvider, bytes productData, string[] capabilityKeys, string[] capabilityValues)
...
// ParseProductAdded is a log parse operation binding the contract event 0xc03038a9ecf24bce3ca992cd5fc58cfc5eef92df68bdcce2a38ad62026932e6e.
//
// Solidity: event ProductAdded(uint256 indexed providerId, uint8 indexed productType, address serviceProvider, bytes productData, string[] capabilityKeys, string[] capabilityValues)
...
// FilterProductUpdated is a free log retrieval operation binding the contract event 0x43123f971453cebc3b94b1b06a1d26d7a5a5b6bf650f3adb0aadfa678103c975.
//
// Solidity: event ProductUpdated(uint256 indexed providerId, uint8 indexed productType, address serviceProvider, bytes productData, string[] capabilityKeys, string[] capabilityValues)
...
// WatchProductUpdated is a free log subscription operation binding the contract event 0x43123f971453cebc3b94b1b06a1d26d7a5a5b6bf650f3adb0aadfa678103c975.
//
// Solidity: event ProductUpdated(uint256 indexed providerId, uint8 indexed productType, address serviceProvider, bytes productData, string[] capabilityKeys, string[] capabilityValues)
...
// ParseProductUpdated is a log parse operation binding the contract event 0x43123f971453cebc3b94b1b06a1d26d7a5a5b6bf650f3adb0aadfa678103c975.
//
// Solidity: event ProductUpdated(uint256 indexed providerId, uint8 indexed productType, address serviceProvider, bytes productData, string[] capabilityKeys, string[] capabilityValues)
