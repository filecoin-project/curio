...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "mk20.DDOV1": {
            ...
            "properties": {
                "allocation_id": {
                    "description": "AllocationId is retained for previously accepted deals and rejected on new intake.",
                    "allOf": [
                        {
                ...
                "duration": {
                    "description": "Duration represents the deal duration in epochs.\nIt must be at least 518400",
                    "type": "integer"
                },
                "market_address": {
