        ...
        return html`
            ...
            (this.editingClientFilter.peers = e.target.value
                ...
                .map((p) => p.trim()))}"
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Pricing Filters (Numbers, comma-separated)</label>
                                    <input
                                        type="text"
                                        class="form-control"
            ...
            (this.editingClientFilter.max_deals_per_hour = parseInt(
                e.target.value
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Max Deal Size per Hour (Bytes)</label>
                                    <input
                                        type="number"
                                        class="form-control"
                                        .value="${this.editingClientFilter.max_deal_size_per_hour}"
                                        @input="${(e) =>
            (this.editingClientFilter.max_deal_size_per_hour = parseInt(
                e.target.value
            ))}"
                                        required
                                    />
