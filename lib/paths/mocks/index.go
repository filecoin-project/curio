...
func (m *MockSectorIndex) BatchStorageDeclareSectors(ctx context.Context, declarations []paths.SectorDeclaration) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BatchStorageDeclareSectors", ctx, declarations)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockSectorIndexMockRecorder) BatchStorageDeclareSectors(ctx, declarations interface{}) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BatchStorageDeclareSectors", reflect.TypeOf((*MockSectorIndex)(nil).BatchStorageDeclareSectors), ctx, declarations)
}
...
func (m *MockSectorIndex) StorageBestAlloc(ctx context.Context, allocate storiface.SectorFileType, ssize abi.SectorSize, pathType storiface.PathType, miner abi.ActorID) ([]storiface.StorageInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StorageBestAlloc", ctx, allocate, ssize, pathType, miner)
...
func (mr *MockSectorIndexMockRecorder) StorageBestAlloc(ctx, allocate, ssize, pathType, miner interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StorageBestAlloc", reflect.TypeOf((*MockSectorIndex)(nil).StorageBestAlloc), ctx, allocate, ssize, pathType, miner)
}
...
func (m *MockSectorIndex) StorageDetach(ctx context.Context, id storiface.ID, url string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StorageDetach", ctx, id, url)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockSectorIndexMockRecorder) StorageDetach(ctx, id, url interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StorageDetach", reflect.TypeOf((*MockSectorIndex)(nil).StorageDetach), ctx, id, url)
}
...
func (m *MockSectorIndex) StorageGetLocks(ctx context.Context) (storiface.SectorLocks, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StorageGetLocks", ctx)
...
func (mr *MockSectorIndexMockRecorder) StorageGetLocks(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StorageGetLocks", reflect.TypeOf((*MockSectorIndex)(nil).StorageGetLocks), ctx)
}
...
func (m *MockSectorIndex) StorageList(ctx context.Context, id storiface.ID) ([]storiface.Decl, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StorageList", ctx, id)
	ret0, _ := ret[0].([]storiface.Decl)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSectorIndexMockRecorder) StorageList(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StorageList", reflect.TypeOf((*MockSectorIndex)(nil).StorageList), ctx, id)
}
