...
func (_FilecoinWarmStorageService *FilecoinWarmStorageServiceTransactor) TerminateService0(opts *bind.TransactOpts, dataSetId *big.Int, extraData []byte) (*types.Transaction, error) {
	return _FilecoinWarmStorageService.contract.Transact(opts, "terminateService0", dataSetId, extraData)
}

// TerminateService0 is a paid mutator transaction binding the contract method 0xd0e3c954.
//
// Solidity: function terminateService(uint256 dataSetId, bytes extraData) returns()
func (_FilecoinWarmStorageService *FilecoinWarmStorageServiceSession) TerminateService0(dataSetId *big.Int, extraData []byte) (*types.Transaction, error) {
	return _FilecoinWarmStorageService.Contract.TerminateService0(&_FilecoinWarmStorageService.TransactOpts, dataSetId, extraData)
}

// TerminateService0 is a paid mutator transaction binding the contract method 0xd0e3c954.
//
// Solidity: function terminateService(uint256 dataSetId, bytes extraData) returns()
func (_FilecoinWarmStorageService *FilecoinWarmStorageServiceTransactorSession) TerminateService0(dataSetId *big.Int, extraData []byte) (*types.Transaction, error) {
	return _FilecoinWarmStorageService.Contract.TerminateService0(&_FilecoinWarmStorageService.TransactOpts, dataSetId, extraData)
}
