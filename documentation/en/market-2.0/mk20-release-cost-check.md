...
Run this finite recipe only with separate authorization against disposable
PostgreSQL and, separately,
...
- Record the exact tested commit and keep its source checkout available. The
