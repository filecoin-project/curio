...
The hub contract supporting voucher payments may be **upgraded, migrated, or abandoned**. We will provide **at least 30 days public notice at least 30 days prior** via our standard public announcement mechanisms of the time. Before the sunset date, you must withdraw any unspent client balance using `completeClientWithdrawal`. After that timeframe, support will not be provided for retrieval of affected funds.
...
4.2 We may freeze or reject transactions that appear non‑compliant with the laws of the operator's jurisdiction, such as sanctions, AML, or counter‑terrorism.
