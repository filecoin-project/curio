...
type CurioChainRPC interface {
	...
	// TODO(NV29): Remove allocation RPC requirements once pre-NV29 support is dropped.
	...
	// TODO(NV29): Remove this allocation RPC requirement once pre-NV29 support is dropped.
