...
BEGIN
    ...
    LOOP
    -- Update piece_index in open_sector_pieces to reflect the new sorted order
    UPDATE open_sector_pieces
    SET piece_index = new_index
    WHERE sp_id = v_sp_id AND sector_number = v_sector_number AND piece_index = sorted_pieces.old_index;
